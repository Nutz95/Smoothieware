...
void ExtruderScreen::display_menu_line(uint16_t line)
{
    switch ( line ) {
		...
		case 3: THEPANEL->lcd->printf("Extrude 200mm"); break;
        case 4: THEPANEL->lcd->printf("Retract 5mm");  break;
		case 5: THEPANEL->lcd->printf("Retract 100mm");  break;
		case 6: THEPANEL->lcd->printf("Retract 200mm");  break;
...
void ExtruderScreen::clicked_menu_entry(uint16_t line)
{
    switch ( line ) {
		...
		case 5: send_command("M120\nG91\nG1 E-100 F600\nM121"); break;
		case 6: send_command("M120\nG91\nG1 E-200 F600\nM121"); break;
        case 7: setupConfigSettings(); break; // lazy load
    }
}
